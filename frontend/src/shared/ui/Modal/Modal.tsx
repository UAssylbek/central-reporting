...
export function Modal({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative w-full bg-white dark:bg-zinc-800 rounded-xl shadow-xl",
      ...
      >
        ...
        {/* Footer */}
        {footer && (
          <div className="px-6 py-4 border-t border-gray-200 dark:border-zinc-700 bg-gray-50 dark:bg-zinc-900 rounded-b-xl">
            {footer}
          </div>
        )}
      </div>
